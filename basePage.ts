import {Builder, Capabilities, until, WebDriver, WebElement, By} from 'selenium-webdriver';
    ...
    async navigate (url?:string): Promise<void> {
        if (url) return await this.driver.get(url);
            ...
            return Promise.reject (
                "BasePage.navigate needs an url defined on the page object or one passed in."
            );
    };
